...
function Eyebrow({ children, color = GP.champagne, dash = false, dot = false }) {
  return (
    <div style={{
      ...
      {dash && <span style={{ width: 18, height: 1, background: color, opacity: 0.6 }}/>}
    ...
    <div style={{
      ...
      <header style={{
        ...
        <div style={{ flex: 1, minWidth: 260 }}>
          {eyebrow && <div style={{ marginBottom: 12 }}><Eyebrow dash={false}>{eyebrow}</Eyebrow></div>}
          <h1 style={{
  ...
  return (
    <aside style={{
      ...
      <div style={{ padding: '18px 24px 8px', position: 'relative' }}>
        <Eyebrow dash={false} color={GP.textOnInkDim}>
